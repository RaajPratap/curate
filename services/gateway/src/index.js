...
// Auth Service Routes
app.use('/api/auth', authLimiter, createProxyMiddleware(createProxyOptions(SERVICES.auth, {
  '^/api/auth': '/api/auth',
})));

// Products Service Routes
app.use('/api/products', createProxyMiddleware(createProxyOptions(SERVICES.products, {
  '^/api/products': '/api/products',
})));

// Orders Service Routes (includes cart)
app.use('/api/orders', createProxyMiddleware(createProxyOptions(SERVICES.orders, {
  '^/api/orders': '/api/orders',
})));

app.use('/api/cart', createProxyMiddleware(createProxyOptions(SERVICES.orders, {
  '^/api/cart': '/api/cart',
})));
